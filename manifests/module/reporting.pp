...
class icingaweb2::module::reporting (
  ...
  Stdlib::HTTPUrl                            $git_repository   = 'https://github.com/Icinga/icingaweb2-module-reporting.git',
  Optional[String[1]]                        $git_revision     = undef,
  Boolean                                    $manage_service   = true,
  Stdlib::Ensure::Service                    $service_ensure   = 'running',
  Boolean                                    $service_enable   = true,
  String[1]                                  $service_user     = 'icingareporting',
  String[1]                                  $db_resource_name = 'reporting',
  Stdlib::Host                               $db_host          = 'localhost',
  String[1]                                  $db_name          = 'reporting',
  String[1]                                  $db_username      = 'reporting',
