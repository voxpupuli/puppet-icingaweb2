...
class icingaweb2::module::x509 (
  ...
  Stdlib::HTTPUrl                            $git_repository   = 'https://github.com/Icinga/icingaweb2-module-x509.git',
  Optional[String[1]]                        $git_revision     = undef,
  Boolean                                    $manage_service   = true,
  Stdlib::Ensure::Service                    $service_ensure   = 'running',
  Boolean                                    $service_enable   = true,
  String[1]                                  $service_user     = 'icingax509',
  String[1]                                  $db_resource_name = 'x509',
  Stdlib::Host                               $db_host          = 'localhost',
  String[1]                                  $db_name          = 'x509',
  String[1]                                  $db_username      = 'x509',
