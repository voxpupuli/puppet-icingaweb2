  ...
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      context "#{os} with git_revision 'v0.9.0'" do
        ...
        it {
          is_expected.to contain_icingaweb2__module('elasticsearch')
      ...
      context "#{os} with an instance" do
        ...
        it {
          is_expected.to contain_icingaweb2__module__elasticsearch__instance('elastic')
        ...
        it {
          is_expected.to contain_icingaweb2__inisection('elasticsearch-instance-elastic')
      ...
      context "#{os} with an event type" do
        ...
        it {
          is_expected.to contain_icingaweb2__module__elasticsearch__eventtype('filebeat')
        ...
        it {
          is_expected.to contain_icingaweb2__inisection('elasticsearch-eventtype-filebeat')
