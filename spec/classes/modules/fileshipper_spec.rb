  ...
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      context "#{os} with a base directory" do
        ...
        it {
          is_expected.to contain_icingaweb2__module__fileshipper__basedir('temp')
            .with_basedir('/tmp')
        }

        it {
          is_expected.to contain_icingaweb2__inisection('fileshipper-basedir-temp')
      ...
      context "#{os} with a directory" do
        ...
        it {
          is_expected.to contain_icingaweb2__module__fileshipper__directory('test')
        ...
        it {
          is_expected.to contain_icingaweb2__inisection('fileshipper-directory-test')
