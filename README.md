...
To submit a pull request via Github, fork [Icinga/puppet-icingaweb2](https://github.com/Icinga/puppet-icingaweb2) and make your changes in a feature branch off of the **develop** branch.
